...
private let THIS_MONTH_PATTERN = "(?:\\u8fd9\\u4e2a\\u6708|\\u9019\\u500b\\u6708|\\u672c\\u6708)"
private let LAST_MONTH_PATTERN = "(?:\\u4e0a\\u4e2a\\u6708|\\u4e0a\\u500b\\u6708|\\u4e0a\\u6708)"

public class ZHThisMonthParser: Parser {
    ...
    override public func extract(text: String, ref: Date, match: NSTextCheckingResult, opt: [OptionType: Int]) -> ParsedResult? {
        ...
        result.tags[.zhThisMonthParser] = true
        return result
    }
}

public class ZHLastMonthParser: Parser {
    ...
    override public func extract(text: String, ref: Date, match: NSTextCheckingResult, opt: [OptionType: Int]) -> ParsedResult? {
        ...
        result.tags[.zhLastMonthParser] = true
        return result
    }
}
