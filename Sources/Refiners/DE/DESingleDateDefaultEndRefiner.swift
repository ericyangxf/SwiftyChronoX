//
//  DESingleDateDefaultEndRefiner.swift
//  SwiftyChrono
//
...
class DESingleDateDefaultEndRefiner: Refiner {
    override public func refine(text: String, results: [ParsedResult], opt: [OptionType: Int]) -> [ParsedResult] {
        ...
        for var result in results {
            ...
            if result.tags[.deMonthNameParser] ?? false {
            ...
            if (result.tags[.deMonthNameLittleEndianParser] ?? false) ||
                (result.tags[.deSlashDateFormatParser] ?? false) ||
                ...
                (result.tags[.deCasualDateParser] ?? false) ||
                (result.tags[.deCasualTimeParser] ?? false) ||
                (result.tags[.deWeekdayParser] ?? false)
            {
                result.end = result.start.clone()
            }
